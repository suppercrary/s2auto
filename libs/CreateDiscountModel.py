...
from core_libs.DataHelper import locators_discount

In_product = locators_discount.get("In_product")
Create_promotion = locators_discount.get("Create_promotion")
inputs_data = locators_discount.get("Create_Product_Amount_Price")

class CreateDiscountModel:
    def __init__(self):
        self.driver = None
